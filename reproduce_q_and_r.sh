...
#             for i in {1..1} ; do
#                 echo "Run $i"
#                 ./LinScale-Cuda --m1 $(($m1)) --n1 $n1 --m2 $m2 --n2 $n1 --compute 1 --join_vals_domain_size 1 --check_accuracy
#             done
#             echo "************************************************"
#         done
# done
...
for m1 in "${m1_a[@]}"; do
    m2=$m1
        for n1 in "${n_a[@]}"; do
            ...
            for i in {1..1} ; do
                echo "Run $i"
                ./LinScale-Cuda --m1 $(($m1)) --n1 $n1 --m2 $m2 --n2 $n1 --compute 1 --join_vals_domain_size 1
            done
            echo "************************************************"
        done
done
